...
psth_tibble <- left_join(psth_tibble, CELL_INFO %>% select(cell_id, pinch, control))
...
APC %>% 
  ...
  geom_segment(aes(x = min(stim_number), y = 1, xend = max(stim_number), yend = 1), size  = 1, color = "black", lty = "dashed") + 
  expand_limits(x = 11) +
