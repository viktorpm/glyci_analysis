...
Determine sync and desync periods
how sliding window for the rolling SD is determined (1 / first_peak * samp_rate_ds): number of data points in a cycle. 


Determine if a cell fires in clusters or not 

ISI is used to determine clusters. Number of bins of the ISI is determined by the Freedman-Diaconis rule for optimal bin-width. ISI window size: 1 / first_peak. Dip test was used to determine ISI uni/multimodality
