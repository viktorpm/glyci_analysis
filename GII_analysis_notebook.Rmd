...
GV_40, GV_42 and GV_47 are electrical stimulations. Might need to be excluded from analysis as well as GII_20 (looks like an outlier). \  
* Response probability was calculated two different ways: 
 + as the number of APs in the boxplot range (25th percentile - 1.5\*IQR, 75th percentile + 1.5\*IQR) * 100 (if the lower range was smaller than 0, values were cut at zero)
 + between 5-20 ms after the stimulus
