...
# wilcox.test(x=x, y=y, alternative = "less", paired = T)
  ...
  #dplyr::filter(!grepl(pattern = "GV115|GII21", ID)) %>% # 01 and 04 are not clustered
  ...
  geom_signif(
    ...
    map_signif_level = TRUE,
    test = "wilcox.test",
    test.args = list(paired = T, alternative = "less"),
    margin_top = .1,
    color = "darkgray"
  ) +
  ggpubr::stat_compare_means(
...
EEG_ds_df %>%
  ...
  ggpubr::stat_compare_means(method = "wilcox.test", paired = T, method.args = list(alternative = "less"))
