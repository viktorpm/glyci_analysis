...
coords %>%
  ...
  add_column(
    rec_time = coords %>% dplyr::filter(animal == "GIIFM21b", body_part == "head") %>% pull(rec_time),
    stim = coords %>% dplyr::filter(animal == "GIIFM21b", body_part == "head") %>% pull(stim)
  ) %>%
...
coords %>%
  dplyr::filter(animal == "GIIFM20b", body_part != "tail") %>%
  dplyr::group_by(session, frame) %>%
  summarise(
    vectx = diff(X_interp),
    vecty = diff(Y_interp)
  ...
  add_column(
    rec_time = coords %>% dplyr::filter(animal == "GIIFM20b", body_part == "head") %>% pull(rec_time),
    stim = coords %>% dplyr::filter(animal == "GIIFM20b", body_part == "head") %>% pull(stim),
    stim_categ = coords %>% dplyr::filter(animal == "GIIFM20b", body_part == "head") %>% pull(stim_categ),
    stim_number = coords %>% dplyr::filter(animal == "GIIFM20b", body_part == "head") %>% pull(stim_number),
    Y_diff = coords %>% dplyr::filter(animal == "GIIFM20b", body_part == "head") %>% pull(Y_diff),
    X_diff = coords %>% dplyr::filter(animal == "GIIFM20b", body_part == "head") %>% pull(X_diff),
    d_mm = coords %>% dplyr::filter(animal == "GIIFM20b", body_part == "head") %>% pull(d_mm),
  ) %>%
  group_by(session) %>%
