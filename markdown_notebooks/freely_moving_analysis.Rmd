...
# Custom function: Remove junk animals from the data
...
cowplot::plot_grid(plt_pop_dist_sum_stim, plt_pop_dist_sum_ctrl, nrow = 2)
```
...
cowplot::plot_grid(plt_distance_dose_stim, plt_distance_dose_ctrl, ncol = 2)
```
