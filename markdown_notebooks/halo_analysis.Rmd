...
plt1_angle +
  ggtitle(paste0(title, ", ", "mean rotation angle by intensity"))
...
```{r fig.width=10}
  ...
  ggtitle(paste0(title, ", ", "mean rotation angle dose dependency"))
...
```{r fig.width=15}
  bind_rows(
    ...
    ggtitle(paste0(title, ", " , "traveled distance"))
```
...
```{r fig.width=10}
  ...
  ggtitle(paste0(title, ", " , "traveled distance dose dependency"))
```
